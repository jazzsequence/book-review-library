...
class Book_Review_Widget extends WP_Widget {
	public function __construct() {
		...
		$this->__construct( 'book-review-widget', 'Similar Books', $widget_options, $control_options );
	}
...
class Book_Review_Recent_Widget extends WP_Widget {
	public function __construct() {
		...
		$this->__construct( 'recent-book-review-widget', __('Recent Book Reviews', 'book-review-library'), $widget_options, $control_options );
	}
